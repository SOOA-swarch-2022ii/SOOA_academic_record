...
from SOOA_academic_record_ms.models.product_model import Product
from SOOA_academic_record_ms.models.category_model import Category
from SOOA_academic_record_ms.serializers.category_serializer import CategorySerializer
